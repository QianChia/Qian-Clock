...
let app = new Vue({
    ...
    methods: {
        ...
        getTime() {
            if (localStorage.getItem("Clock-isShowChineseDate") == 1) {
                this.date = formatDate_lunarDate(new Date());
            } else {
                this.date = new Date();
            }
        },
    ...
    computed: {
        ...
        year() {
            if (localStorage.getItem("Clock-isShowChineseDate") == 1) {
                return formatDateY_lunar_A(new Date());
            } else {
        ...
        dayList() {
            ...
            for (let i = 1; i <= total; i++) {
                ...
                if (localStorage.getItem("Clock-isShowChineseDate") == 1) {
                    dayStr = dayStr.replace('二十', '廿');
                    dayStr = dayStr.replace('三十', '卅');
                    if (i < 11) {
